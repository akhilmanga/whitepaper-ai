...
const LoginPage: React.FC = () => {
  const [email, setEmail] = useState('demo@whitepaper.ai')
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
          Sign in to Whitepaper AI
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Transform whitepapers into interactive learning experiences
        </p>
      </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                In development mode, any email/password combination will work.
              </p>
              <p className="text-xs text-gray-500 mt-2">
                Default: demo@whitepaper.ai / password123
              </p>
            </div>
          </div>
